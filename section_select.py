...
targ_sections = ["diagnosis","past or present history of illness","social family history","physical or laboratory examination","medication disposition"]
threshold = 0.6
...
#Set folder
preprocessing_path=root+"preprocessing/"
